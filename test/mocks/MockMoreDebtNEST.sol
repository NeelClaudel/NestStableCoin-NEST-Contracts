 ...
 */
contract MockMoreDebtNEST is ERC20Burnable, Ownable {
    ...
    For example:
    constructor() ERC20("NestStableCoin", "NEST") Ownable(0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266) {}
    Related code changes can be viewed in this commit:
    https://github.com/OpenZeppelin/openzeppelin-contracts/commit/13d5e0466a9855e9305119ed383e54fc913fdc60
    */
    constructor(address _mockAggregator) ERC20("NestStableCoin", "NEST") {
    ...
    function burn(uint256 _amount) public override onlyOwner {
        ...
        if (balance < _amount) {
            revert NestStableCoin__BurnAmountExceedsBalance();
        }
        super.burn(_amount);
    }
